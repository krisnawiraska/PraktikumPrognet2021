...
<body>
    ...
    <footer id="footer" class="footer style-03">
        <div class="section-001 section-020">
            <div class="container">
                <div class="Halilintar-newsletter style-03">
                    <div class="newsletter-inner">
                        <div class="newsletter-info">
                            <div class="newsletter-wrap">
                                <h3 class="title">Newsletter</h3>
                                <h4 class="subtitle">PETS SHOP NO 1 IN BALI</h4>
                                <p class="desc"></p>
                            </div>
                        </div>
        ...
        <div class="section-021">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="Halilintar-listitem style-03">
...
function loadnotif(){
        $.ajax({
                ...
                success: function(data){
                    ...
                    jQuery.each(responsedata.list, function(index, value){
                        count ++;
                        $('ul.sub-menu.notif .notifi').append('<li class="listnotif" class="menu-item Halilintar-MyAccount-navigation-link Halilintar-MyAccount-navigation-link--dashboard is-active">'+value.data+'<hr> </li>');
                        if(index == 0){
    ...
    function loadcount(){
        $.ajax({
                ...
                success: function(data){
                    ...
                    if (data < 1) {
                        $('a.button.Halilintar-forward').addClass('w-100')
                        $('a.button.checkout.Halilintar-forward').addClass('d-none')
                    }else{
                        $('a.button.Halilintar-forward').removeClass('w-100')
                        $('a.button.checkout.Halilintar-forward').removeClass('d-none')
                    }
                }
            });
    }
    ...
    function loadtotal(){
        $.ajax({
                ...
                type: 'get',
                success: function(data){
                    $('span .Halilintar-Price-currencySymbol-totals').html(data);
                }
            });
    }
    ...
    var spans = $(this).closest("tr").find("span.Halilintar-Price-amount.amount.subtotal").html('Rp '+format(total));
        }else{
