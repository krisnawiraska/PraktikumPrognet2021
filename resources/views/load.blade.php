{{-- <div id="result" class="row" style="position: relative;">
...
<div
    ...
    <div class="product-inner tooltip-top">
        ...
        <div class="product-info">
            ...
            <span class="price"><span class="Halilintar-Price-amount amount"><span
                        class="Halilintar-Price-currencySymbol">{{"Rp " . number_format($product->price,2,',','.')}}</span>
        </div>
...
@endforeach
<div class="pagitnaion w-100 d-flex justify-content-center">{{$products->links()}}</div>
</div> --}}