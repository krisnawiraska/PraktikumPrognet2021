    ...
    <div class="container">
        <div class="bayar">
            <h1 class="text-center text-primary font-weight-bolder">
                ...
                <br>
                <small>Transfer To : 6485255463</small>
                <hr>
            </h1>
        </div>
        <div class="time text-center">
            ...
            <form action="{{Route('cancel',['transactions' => $transaksi->id])}}" method="POST"
                ...
                @method('put')
                @csrf
                <button type="submit" onclick="return confirm('Yakin ingin Membatalkan Pesanan?')">Cancel Transaction</button>
            </form>
            @else
        ...
        <div class="row pt-5">
            ...
            <div class="main-content col-md-6">
                ...
                <div class="col2-set w-100" id="customer_details">
                    <div class="col-1">
                        <div class="Halilintar-billing-fields">
                            <h3>Upload Bukti Bayar</h3>
                            <div class="Halilintar-billing-fields__field-wrapper">
                                <form action="{{Route('upload-bukti',['transactions' => $transaksi->id])}}"
                                    ...
                                    <p class="form-row form-row-wide bukti-field validate-required form-group"
                                        id="billing_bukti_1_field" data-priority="50"><label for="billing_bukti_1"
                                            ...
                                            class="Halilintar-input-wrapper">
            ...
            <div
                ...
                <div class="page-main-content">
                    <div class="Halilintar">
                        <div class="Halilintar-notices-wrapper"></div>
                        <form class="Halilintar-cart-form">
                            <table class="shop_table shop_table_responsive cart Halilintar-cart-form__contents"
                                cellspacing="0">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr class="Halilintar-cart-form__cart-item cart_item">
                                        <td class="name">
                                            <p>{{$item->product->product_name}}</p></td>
                                        <td class="prices">
                            ...
                            <table class="shop_table shop_table_responsive" cellspacing="0">
                                <tbody>
                                    <tr class="cart-subtotal">
                                        <th>Subtotal</th>
                                        <td data-title="Subtotal"><span class="Halilintar-Price-amount amount"><span
                                                    class="Halilintar-Price-currencySymbol">{{"Rp " . number_format($transaksi->sub_total,2,',','.')}}</span>
                                        </td>
                                    </tr>
                                    <tr class="cart-shipng">
                                        <th>Ongkos Kirim</th>
                                        <td data-title="shipig"><span class="Halilintar-Price-amount amount"><span
                                                    class="Halilintar-Price-currencySymbol">{{"Rp " . number_format($transaksi->shipping_cost,2,',','.')}}</span>
                                        </td>
                                    </tr>
                                    <tr class="order-total">
                                        <th>Total</th>
                                        <td data-title="Total"><strong><span class="Halilintar-Price-amount amount"><span
                                                        class="Halilintar-Price-currencySymbol">{{"Rp " . number_format($transaksi->total,2,',','.')}}</span></strong>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
