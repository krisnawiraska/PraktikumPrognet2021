            ...
            <div class="main-content col-md-12">
                <div class="page-main-content">
                    <div class="Halilintar">
                        ...
                        <form action="{{Route('checkout-all')}}" method="post" class="checkout Halilintar-checkout"
                                    ...
                                    <div class="Halilintar-billing-fields">
                                        ...
                                        <div class="Halilintar-billing-fields__field-wrapper">
                                            ...
                                            <p class="form-row form-row-wide addresses-field update_totals_on_change validate-required"
                                                ...
                                                <span class="Halilintar-input-wrapper">
                                            ...
                                            <p class="form-row form-row-wide alamat-field validate-required"
                                                id="billing_alamat_1_field" data-priority="50"><label
                                                    ...
                                                    class="Halilintar-input-wrapper"><input required type="text"
                            ...
                            <div id="order_review" class="Halilintar-checkout-review-order">
                                <table class="shop_table Halilintar-checkout-review-order-table">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-total">
                                                <span class="Halilintar-Price-amount amount">
                                                    @php
                                                    $is_discount = false;
                                                    @endphp
                                    ...
                                    <tfoot>
                                        <tr class="cart-subtotal">
                                            <th>Sub Total</th>
                                            <td><span
                                                    class="Halilintar-Price-amount amount">{{"Rp " . number_format($total,0,',','.')}}</span>
                                            </td>
                                        </tr>
                                        <tr class="cart-subtotal">
                                            <th>Ongkir</th>
                                            <td><span class="Halilintar-Price-amount amount" id="ongkir">0</span></td>
                                        </tr>
                                        <tr class="cart-subtotal">
                                            <th>Berat Total</th>
                                            <td><span class="Halilintar-Price-amount amount" id="berat"
                                        ...
                                        <tr class="order-total">
                                            ...
                                            <td><strong><span data-total="{{$total}}" id="total"
                                                        class="Halilintar-Price-amount amount">{{"Rp " . number_format($total,0,',','.')}}</span></strong>
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
                                <div>
                                    ...
                                    <input type="hidden" id="Halilintar-process-checkout-nonce"
                                        value="634590c981"><input type="hidden"
                                        value="/Halilintar/?Halilintar-ajax=update_order_review">
                                </div>
                            </div>
                        </form>
                    </div>
