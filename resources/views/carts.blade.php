            ...
            <div class="main-content col-md-12">
                <div class="page-main-content">
                    <div class="Halilintar">
                        ...
                        <div class="Halilintar-cart-form">
                            <table class="shop_table shop_table_responsive cart Halilintar-cart-form__contents"
                                ...
                                <tbody>
                                    ...
                                    <tr class="Halilintar-cart-form__cart-item cart_item">
                                        ...
                                        <td class="product-price" data-title="Price">
                                            <span class="Halilintar-Price-amount amount subtotal">
                                                @if($is_discount)
                        ...
                        <div class="cart-collaterals">
                            <div class="cart_totals ">
                                ...
                                <table class="shop_table shop_table_responsive" cellspacing="0">
                                    <tbody>
                                        <tr class="order-total">
                                            <th>Total</th>
                                            <td data-title="Total">
                                                <strong><span class="Halilintar-Price-amount amount sub-total">
                                                        <span
                                ...
                                <div class="Halilintar-proceed-to-checkout @if ($carts->count() < 1) d-none @endif">
                                    <a href="{{Route('checkout')}}" class="checkout-button button alt Halilintar-forward">
